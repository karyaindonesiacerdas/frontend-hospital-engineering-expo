  ...
  return (
    <div className="group">
      <button className={styles.button} onClick={onClick}>
        ...
        <div className="btn-thumbnail group-hover:hidden absolute inset-0 flex items-center justify-center w-full h-full">
          <svg
            className="pl-1 opacity-10 animate-pulse rounded-full border-primary-500"
            fill="none"
            viewBox="0 0 24 24"
          >
            <path
