...
export const UpdateExhibitorPackage = ({
  open,
  setOpen,
  selectedExhibitor,
  ...
  const [packageId, setPackageId] = useState(selectedExhibitor.package_id);
  ...
  useEffect(() => {
    setPackageId(selectedExhibitor?.package_id);
  }, [selectedExhibitor]);

  const handleChangePackage: FormEventHandler<HTMLFormElement> = async (e) => {
    e.preventDefault();
