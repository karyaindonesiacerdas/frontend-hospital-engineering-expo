...
import styles from "./ExhibitorListLink.module.css";

export const ExhibitorListLink = () => {
  return (
    <div className={styles.link}>
      <a
        href="exhibitor-list.html"
        className="h-full bg-[#A6FAFF] bg-opacity-100 w-full rounded-md text-[#00B4BF] border-[4px] border-[#00B4BF] flex items-center justify-center space-x-2"
      >
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
          data-icon="door-open"
          className="svg-inline--fa fa-door-open fa-w-20 w-8 h-8"
          role="img"
